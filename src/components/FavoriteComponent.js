...
const Favorites = (props) => {
    ...
    if (props.favorites.isLoading) {
        ...
        const favorites = props.favorites.favorites.dishes.map((dishId) => { // favorites.dishes is an array of all the dishIds. So I look at each dishId, and then from the dishes (that we also passed into the Favorite component in Main) I filter out that particular dish to then render that particular dish:
